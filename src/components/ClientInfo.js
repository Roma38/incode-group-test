        ...
        <Container text textAlign="justified">
          ...
          <List inverted>
            <List.Item
              icon="phone"
              content={
                <a href={`callto:${this.props.client.contact.phone}`}>
            ...
            <List.Item
              icon="mail"
              content={
                <a href={`mailto:${this.props.client.contact.email}`}>
            ...
            <List.Item
              icon="point"
              content={
                this.props.client.address.city +
                ", " +
            ...
            <List.Item
              ...
              content={this.props.client.address.street}
            />
          </List>
        </Container>
      </div>
